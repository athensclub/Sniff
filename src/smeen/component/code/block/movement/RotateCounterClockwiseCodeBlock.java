...
public class RotateCounterClockwiseCodeBlock extends CodeBlock {

    private CodeBlockInputSlot<Double> amount;

    public RotateCounterClockwiseCodeBlock(MainView main) {
        super(main);
        Label first = new Label("หมุนทวนเข็ม");
    ...
    public CodeBlock copy() {
        RotateCounterClockwiseCodeBlock copy = new RotateCounterClockwiseCodeBlock(getMain());
    ...
    public Map<String, Object> exportData() {
        ...
        result.put("type", "RotateCounterClockwiseCodeBlock");
