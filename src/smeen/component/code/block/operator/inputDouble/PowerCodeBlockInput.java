...
public class PowerCodeBlockInput extends CodeBlockInput<Double> {
	private CodeBlockInputSlot<Double> slot1 , slot2;
	public PowerCodeBlockInput(MainView main) {
		super(main);
    ...
    public CodeBlockInput<?> copy() {
    	PowerCodeBlockInput copy = new PowerCodeBlockInput(getMain());
	...
	public Double getValue(SmeenContext context) {
		return  (double) Math.pow(slot1.getValue(context) , slot2.getValue(context));
	}
	...
	public Map<String, Object> exportData() {
		...
		result.put("type", "PowerCodeBlockInput");
