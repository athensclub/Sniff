...
public class AddCodeBlockInput extends CodeBlockInput<Double> {
	
	private CodeBlockInputSlot<Double> slot1 , slot2;
	public AddCodeBlockInput(MainView main) {
		super(main);
    ...
    public CodeBlockInput<?> copy() {
    	AddCodeBlockInput copy = new AddCodeBlockInput(getMain());
	...
	public Map<String, Object> exportData() {
		...
		result.put("type", "AddCodeBlockInput");
