...
public class MultiCodeBlockInput extends CodeBlockInput<Double> {
	
	private CodeBlockInputSlot<Double> slot1 , slot2;
	public MultiCodeBlockInput(MainView main) {
		super(main);
    ...
    public CodeBlockInput<?> copy() {
    	MultiCodeBlockInput copy = new MultiCodeBlockInput(getMain());
	...
	public Map<String, Object> exportData() {
		...
		result.put("type", "MultiCodeBlockInput");
