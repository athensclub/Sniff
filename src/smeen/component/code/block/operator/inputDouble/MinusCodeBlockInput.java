...
public class MinusCodeBlockInput extends CodeBlockInput<Double> {
	
	private CodeBlockInputSlot<Double> slot1 , slot2;
	public MinusCodeBlockInput(MainView main) {
		super(main);
    ...
    public CodeBlockInput<?> copy() {
    	MinusCodeBlockInput copy = new MinusCodeBlockInput(getMain());
	...
	public Map<String, Object> exportData() {
		...
		result.put("type", "MinusCodeBlockInput");
