...
public class ModCodeBlockInput extends CodeBlockInput<Double> {
	private CodeBlockInputSlot<Double> slot1 , slot2;
	public ModCodeBlockInput(MainView main) {
		super(main);
    ...
    public CodeBlockInput<?> copy() {
    	ModCodeBlockInput copy = new ModCodeBlockInput(getMain());
	...
	public Map<String, Object> exportData() {
		...
		result.put("type", "ModCodeBlockInput");
