...
public class OrCodeBlockInput extends CodeBlockInput<Boolean> {
	...
	public CodeBlockInput<?> copy() {
		OrCodeBlockInput copy = new OrCodeBlockInput(getMain());
	...
	public Map<String, Object> exportData() {
		...
		result.put("type", "OrCodeBlockInput");
