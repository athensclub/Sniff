...
public class GreaterCodeBlockInput extends CodeBlockInput<Boolean> {
	private CodeBlockInputSlot<Double> slot1 , slot2;
	public GreaterCodeBlockInput(MainView main) {
		super(main);
    ...
    public CodeBlockInput<?> copy() {
    	GreaterCodeBlockInput copy = new GreaterCodeBlockInput(getMain());
	...
	public Map<String, Object> exportData() {
		...
		result.put("type", "GreaterCodeBlockInput");
