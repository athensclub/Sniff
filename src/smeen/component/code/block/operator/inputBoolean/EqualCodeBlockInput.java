...
public class EqualCodeBlockInput extends CodeBlockInput<Boolean> {
	private CodeBlockInputSlot<Double> slot1 , slot2;
	public EqualCodeBlockInput(MainView main) {
		super(main);
    ...
    public CodeBlockInput<?> copy() {
    	EqualCodeBlockInput copy = new EqualCodeBlockInput(getMain());
	...
	public Boolean getValue(SmeenContext context) {
		return  slot1.getValue(context).equals(slot2.getValue(context));
	}
	...
	public Map<String, Object> exportData() {
		...
		result.put("type", "EqualCodeBlockInput");
