...
public class LessCodeBlockInput extends CodeBlockInput<Boolean> {
	private CodeBlockInputSlot<Double> slot1 , slot2;
	public LessCodeBlockInput(MainView main) {
		super(main);
    ...
    public CodeBlockInput<?> copy() {
    	LessCodeBlockInput copy = new LessCodeBlockInput(getMain());
	...
	public Map<String, Object> exportData() {
		...
		result.put("type", "LessCodeBlockInput");
