...
public class JoinCodeBlockInput extends CodeBlockInput<String> {
    ...
    public CodeBlockInput<?> copy() {
    	JoinCodeBlockInput copy = new JoinCodeBlockInput(getMain());
	...
	public Map<String, Object> exportData() {
		...
		result.put("type", "JoinCodeBlockInput");
